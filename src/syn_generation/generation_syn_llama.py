...
class SynonymGenerator:
    ...
    def generate_synonyms_llama(self, word):
        ...
        try:
            ...
            prompt = f"Provide a plain, clean list of synonyms for the word '{word}'. Do not include any newlines, bullet points, special characters, or formatting. Just output the synonyms as a simple, comma-separated list of words without any extra spaces or symbols."
