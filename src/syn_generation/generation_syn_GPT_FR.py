...
class SynonymGenerator:
    ...
    def generate_synonyms_gpt(self, word):
        ...
        try:
            ...
            messages = [
                {"role": "system", "content": "Vous êtes un assistant utile qui fournit des synonymes pour les mots."},
                {"role": "user", "content": f"Donnez une liste simple et propre de synonymes pour le mot '{word}'. N'incluez pas de sauts de ligne, de points, de caractères spéciaux ou de formatage. Donnez simplement les synonymes sous forme de liste de mots séparés par des virgules sans espaces ou symboles supplémentaires."}
            ]
